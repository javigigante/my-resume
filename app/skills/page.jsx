            ...
            <div className="w-11/12 h-full pt-8 flex flex-col items-center">
                <div className="w-full flex justify-center items-center gap-8 mb-8">
                    <div className="w-1/2 h-auto flex-grow">
                        <div className="rounded-xl p-6 overflow-hidden min-h-72 glass border hover:bg-slate-700 border-gray-600/[0.5] h-full flex flex-col">
                    ...
                    <div className="w-1/2 h-auto flex-grow">
                        <div className="rounded-xl p-6 min-h-72 glass border hover:bg-slate-700 border-gray-600/[0.5] h-full flex flex-col">
                            <div className="flex gap-3 items-center mb-4">
                                <div className="w-14 h-14">
                ...
                <div className="w-full flex justify-center items-center gap-8">
                    <div className="w-1/2 h-auto flex-grow">
                        <div className="rounded-xl p-6 glass min-h-80 border hover:bg-slate-700 border-gray-600/[0.5] h-full flex flex-col">                            
                            <div className="flex gap-3 items-center mb-4">
                                <div className="w-14 h-14">
                    ...
                    <div className="w-1/2 h-auto flex-grow">
                        <div className="rounded-xl p-6 min-h-80 glass border hover:bg-slate-700 border-gray-600/[0.5] h-full flex flex-col">
                            <div className="flex gap-3 items-center mb-4">
                                <div className="w-14 h-14">
