...
const Hero = () => {
  return (
    <div className="w-full z-20 h-full flex justify-center items-center flex-col">
      <div className="w-11/12 h-full md:pt-14 pt-20 flex sm:flex-row flex-col-reverse justify-center items-center">
        <div className="sm:w-7/12 w-full">
          <div className="text_container">
            <h5 className="md:text-md text-sm text-gray-600">¡Muy buenas!</h5>
            <h2 className="text-3xl md:text-7xl font-bold">Soy <span className="text-primarycolor">JaviGigante</span>,<br /> Desarrollador Backend</h2>
            ...
            <a href="./cv Javier.pdf" className="inline-block sm:pl-5 md:pl-1">
        ...
        <div className="sm:w-5/12 w-full flex justify-center items-center pl-4">
          <div className="hero_img_container md:w-full w-60 md:max-w-xs sm:w-full sm:h-full bg-slate-900 p-3 rounded-3xl border border-gray-600/[0.5] shadow-2xl shadow-blue-500/20 aspect-[3/4]">
            <img src="./img/javi-cv-bn.jpg" alt="img_javi_bn" className="w-full h-full rounded-3xl object-cover" />
          </div>
        </div>
      </div>
      <div className="w-11/12 flex md:flex-row flex-col md:gap-5 gap-4 py-8 justify-center items-stretch">        
        <div className="flex-1 flex md:min-h-52 min-h-40 items-center md:h-56 bg-slate-900 py-7 rounded-3xl border border-gray-600/[0.5] shadow-2xl shadow-blue-500/20 md:gap-6 gap-3">
        ...
        <div className="flex-1 flex md:min-h-52 min-h-36 items-center md:h-full h-56 bg-slate-900 md:py-8 py-2 rounded-3xl border border-gray-600/[0.5] shadow-2xl shadow-blue-500/20">
